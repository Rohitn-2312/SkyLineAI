    ...
    <div className='flex flex-col  justify-center max-w-4xl mx-auto space-y-10'>
      ...
      <div className='devcenter flex-col flex '>
        <div className='flex gap-1 items-center'>
          ...
          <a className="text-blue-300 hover:text-blue-900 "  href="mailto:rdc225305@gmail.com">skinlineai@gmail.com</a>
        </div>
        <div className='flex gap-1 items-center'>
        ...
        <div className='flex gap-1 items-center'>
          ...
          <a  className="text-blue-300 hover:text-blue-900 " href="geo:27.174290, 81.215767" target="_blank" rel='noreferrer'>SkinLine AI</a>
        </div>
      </div>
    </div>
    <Doctor/>
