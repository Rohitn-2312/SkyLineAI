...
import Vision from "./Vision";  // Import the Vision component
import SignIn from "./SignIn";  // Import the Vision component
        ...
        <div className="max-w-7xl mx-auto">
          <BrowserRouter>
            ...
            <Routes>
              ...
              <Route path="/vision" element={<Vision />} /> {/* Add this line for the Vision route */}
              <Route path="/signin" element={<SignIn />} /> {/* Add this line for the Vision route */}
            </Routes>
          </BrowserRouter>
        </div>
        <Footer />
