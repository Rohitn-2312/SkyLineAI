...
export default function Doctor() {
  const docs = {
    "Dr. Yug Gupta": "Dermatologist",
    "Dr. Vimarsh Gurkha": "Dermatologist",
  };
  ...
  const devs = {
    Rohit: "Website Developer & Designer",
    Chirag: "AIML Expert",
  };
  ...
  return (
    <div className="px-5 py-5 flex doccenter flex-wrap flex-row container">
      <h1 className="text-4xl font-bold mt-2 text-center">Consult</h1>
      <div className="container doccenter rounded-t-3xl flex flex-wrap flex-row">
        {Object.entries(docs).map(([e, i], s) => {
          return (
            <div key={s} className="mt-5 p-3 rounded-t-3xl w-full md:w-1/2 lg:w-1/3">
              <div className="p-8 max-w-full bg-white border border-gray-200 rounded-lg shadow-md bg-gradient-to-br from-blue-900 to-green-900">
      ...
      <div className="container doccenter rounded-t-3xl flex flex-wrap flex-row">
        {Object.entries(devs).map(([e, i], j) => {
          return (
            <div key={j} className="mt-5 p-3 rounded-t-3xl w-full md:w-1/2 lg:w-1/3">
              <div className="p-8 max-w-full bg-white bg-gradient-to-br from-blue-900 to-green-900 border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
                <div className="m-5 flex flex-col items-center ">
                  <img
                    className="w-24 h-24 mb-3 rounded-full shadow-lg"
